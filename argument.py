def add_arguments(parser):
    ...
    parser.add_argument('--replay_buffer_size', type=int, default=50000, help='replay buffer size for training')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size for training')
    parser.add_argument('--img_height', type=int, default=3, help='image height for training')
    parser.add_argument('--img_width', type=int, default=10, help='image width for training')
